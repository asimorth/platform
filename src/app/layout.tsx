            ...
            <footer className="bg-gray-900 text-white py-12">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                      <li><Link href="/character" className="hover:text-white transition-colors">Karakter Yarat</Link></li>
                      <li><Link href="/manage" className="hover:text-white transition-colors">Karakter Yönet</Link></li>
                      <li><Link href="/gundem" className="hover:text-white transition-colors">Gündem Oluştur</Link></li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                      ...
                      <li><a href="mailto:info@asimorth.com" className="hover:text-white transition-colors">İletişim</a></li>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                  <p>&copy; 2025 Asimorth. Tüm hakları saklıdır.</p>
                </div>
              </div>
            </footer>
          </AuthProvider>
